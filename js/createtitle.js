function settitle() {
    ...
    var addtoslidenav = `<li><a href="#modal1" class="waves-effect waves-dark  btn modal-trigger btn tooltipped" data-position="bottom" data-delay="50"><span class="new badge" id="spannew">0</span>${maketitle}</a></li>`;
